...
void MainWindow::on_slidervolume_actionTriggered(int action)
{
...
{
    player->setMedia(QUrl::fromLocalFile("C:/Users/esprit/Desktop/QT nawres/First Project/son/son2.wav"));
    player->play();
