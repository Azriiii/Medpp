...
QSqlQuery stafft::recherche1(QString res)
{
...
QSqlQuery stafft::recherche2(QString res)
{

    QSqlQuery Quary ;
    Quary.prepare("select * from STAFF where CIN=:nom OR TEL=:nom OR CONTRAT=:nom OR SALAIRE=:nom OR HORAIRE=:nom") ;
