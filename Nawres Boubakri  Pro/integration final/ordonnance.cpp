...
model->setHeaderData(3, Qt::Horizontal, QObject::tr("reff_const"));
...
QSqlQueryModel * ordonnance ::tri_reff_ord()
{
 ...
 QSqlQueryModel * ordonnance ::tri_reff_date()
 {
  ...
  int ordonnance::doliprane()
  {

      int nbf=0;
      QSqlQuery query ("select * from Ordonnance where TRAITEMENT='doliprane'");
      while(query.next())
      {
          nbf++;
      }
  ...
  int ordonnance::aspirine()
  {

      int nbf=0;
      QSqlQuery query ("select * from Ordonnance where TRAITEMENT='aspirine'");
      while(query.next())
      {
          nbf++;
      }
  ...
  int ordonnance::panadole()
  {

      int nbf=0;
      QSqlQuery query ("select * from Ordonnance where TRAITEMENT='panadole'");
      while(query.next())
      {
          nbf++;
      }
  ...
  int ordonnance::fervexe()
  {

      int nbf=0;
      QSqlQuery query ("select * from Ordonnance where TRAITEMENT='fervexe'");
      while(query.next())
      {
          nbf++;
      }
