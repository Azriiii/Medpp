...
void Ordonances::on_radioButton_clicked()
{
    ordonnance c;
...
void Ordonances::on_radioButton_2_clicked()
{
    ordonnance c;
...
void Ordonances::on_radioButton_3_clicked()
{
    ordonnance c;
...
{
    ordonnance o;
    o.recherche_ordonnance(ui->TabOrd,ui->reff_2->text().toInt());
}
...
void Ordonances::on_pushButton_8_clicked()
{
    ordonnance c;
     ...
     if(ui->label_3->text().isEmpty())
     {
         ...
         c.recherche_ordonnance(ui->tableView_o,ui->label_3->text().toInt());

     }
     else {


    int reff_ord=ui->label_3->text().toInt();
    c.recherche_ordonnance(ui->tableView_o,reff_ord); }
