...
bool maher2::ajouter()
{
    ...
    */
    ...
    query.prepare("INSERT INTO FACTURES ( ORDRE_DE , ETAT , ID_FACTURE , RIB , DATE_FACT ) "
...
{
QSqlQuery query ;
query.prepare("UPDATE FACTURES SET  ID_FACTURE= :ID_FACTURE , RIB= :RIB , ORDRE_DE= :ORDRE_DE , DATE_FACT = :DATE_FACT , ETAT = :ETAT where ID_FACTURE= :ID_FACTURE ");
query.bindValue(":ID_FACTURE",ID_FACTURE) ;
query.bindValue(":RIB",RIB);
query.bindValue(":ORDRE_DE",ORDRE_DE);
